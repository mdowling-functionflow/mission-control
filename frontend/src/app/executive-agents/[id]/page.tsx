...
export default function AgentDetailPage() {
  ...
  if (loading) {
    return (
      <DashboardPageLayout signedOut={{ message: "Sign in to access Mission Control", forceRedirectUrl: "/dashboard" }} title="Agent">
  ...
  if (!agent) {
    return (
      <DashboardPageLayout signedOut={{ message: "Sign in to access Mission Control", forceRedirectUrl: "/dashboard" }} title="Agent not found">
