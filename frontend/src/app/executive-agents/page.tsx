...
export default function ExecutiveAgentsPage() {
  ...
  return (
    <DashboardPageLayout signedOut={{ message: "Sign in to access Mission Control", forceRedirectUrl: "/dashboard" }} title="Executive Team" description="Your AI executive agents">
      <SignedOut>
